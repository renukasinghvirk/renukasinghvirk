...
- **Automated Coin Detection**  
 Conducted a computer vision project for EE-451 for the detection and classification of euro and franc coins, building an automated classification system. [Results](https://github.com/renukasinghvirk/Project_imageanalysis/blob/main/Coin_Detection.ipynb)
